...
enum
{
	...
	LINUX_MIB_NFTSLOWPATHPACKETS,		/* NftSlowPathPackets */
	LINUX_MIB_NFTFASTPATHPACKETS,		/* NftFastPathPackets */
	LINUX_MIB_NFTQDISCPACKETS,		/* NftQDiscPackets */
	LINUX_MIB_NFTNETDEVERR,			/* NftNetDevError */
	LINUX_MIB_NFTFASTPATHNEIGHERROR,	/* NftFastPathNeighError */
	LINUX_MIB_NFTFASTPATHERROR,		/* NftFastPathError */
	LINUX_MIB_NFTFASTPATHOK,		/* NftFastPathOk */
	__LINUX_MIB_XFRMMAX
};
