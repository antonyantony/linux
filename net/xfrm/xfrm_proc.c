...
static const struct snmp_mib xfrm_mib_list[] = {
	...
	SNMP_MIB_ITEM("NftSlowPathPackets", LINUX_MIB_NFTSLOWPATHPACKETS),
	SNMP_MIB_ITEM("NftFastPathPackets", LINUX_MIB_NFTFASTPATHPACKETS),
	SNMP_MIB_ITEM("NftQDiscPackets", LINUX_MIB_NFTQDISCPACKETS),
	SNMP_MIB_ITEM("NftNetDevError", LINUX_MIB_NFTNETDEVERR),
	SNMP_MIB_ITEM("NftFastPathNeighError", LINUX_MIB_NFTFASTPATHNEIGHERROR),
	SNMP_MIB_ITEM("NftFastPathError", LINUX_MIB_NFTFASTPATHERROR),
	SNMP_MIB_ITEM("NftFastPathOK", LINUX_MIB_NFTFASTPATHOK),
	SNMP_MIB_SENTINEL
};
